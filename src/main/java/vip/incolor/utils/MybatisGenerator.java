...
/**
 * 逆向生成工具，用于根据数据库的表自动生成mapper类，pojo类和mapper对应的XML
 * 使用时请配合classpath下的generatorConfig.xml文件
 */
public class MybatisGenerator {
    public static void main(String[] args) throws Exception {
        String configFile = "generatorConfig.xml";
        String today = "2018-5-19";
        ...
        InputStream is = MybatisGenerator.class.getClassLoader().getResource(configFile).openStream();
